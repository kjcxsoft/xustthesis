...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.3\textwidth]{xust/badge-green}
  \caption{图号、图题置于图的下方}
  \label{fig:badge}
  \note{注：图注的内容不宜放到图题中。}
\end{figure}
...
\begin{figure}[htb]
  \centering
  \textcolor{xustblue}{\includegraphics[width=0.3\textwidth]{xust/badge-black}}
  \caption{彩色}
  \label{fig:badge-color}
\end{figure}
...
请阅读宏包的官方文档, \autoref{algo:algorithm1} 。
